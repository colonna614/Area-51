...
public class WaveSystem : MonoBehaviour
{
    ...
    void Update()
    {
        Waves.text = "Wave: " + waveNum.ToString();
            ...
            Boss1Behavior.boss1IsDead == true || (TimsBehavior.TimIsDead == true && TomsBehavior.TomIsDead == true) 
            || Boss3Behavior.boss3IsDead == true || Boss4Behavior.boss4IsDead == true)
            {
            ...
            Boss4Behavior.boss4IsDead = false;
